...
(function($){
   ...
   $.fn.prettyPhoto=function(pp_settings){
      pp_settings=jQuery.extend({animation_speed:'fast',slideshow:false,autoplay_slideshow:false,opacity:0.80,show_title:true,allow_resize:true,default_width:500,default_height:344,counter_separator_label:'/',theme:'facebook',hideflash:false,wmode:'opaque',autoplay:true,modal:false,overlay_gallery:true,keyboard_shortcuts:true,changepicturecallback:function(){},callback:function(){},markup:'<div class="pp_pic_holder" style="min-width:720px; display: 0 auto;"> \
                           <div class="ppt">&nbsp;</div> \
                           <div class="pp_top" > \
                               <div class="pp_middle" style="background-color:black;"></div> \
                               <div class="pp_left" style="background-color:black;"></div> \
                               <div class="pp_right" style="background-color:black;"></div> \
                           </div> \
                           <div class="pp_content_container" > \
                               <div class="pp_left" style="background-color:black;"> \
                                  <div class="pp_right" style="background-color:black;"> \
                                      <div class="pp_content"  style="background-color:black;"> \
      ...
      function _fitToViewport(width,height){
         ...
         return{
            width:Math.floor(imageWidth), height:Math.floor(imageHeight), containerHeight:Math.floor(pp_containerHeight), containerWidth:Math.floor(pp_containerWidth)+40, contentHeight:Math.floor(pp_contentHeight), contentWidth:Math.floor(pp_contentWidth), resized:resized
         };
      };
      function _getDimensions(width,height){
         ...
         $pp_details.width(720);
         detailsHeight=parseFloat($pp_details.css('marginTop'))+parseFloat($pp_details.css('marginBottom'));

         //$pp_details.css('background-color': 'red');
         ...
         if($.browser.msie&&$.browser.version==7)
            detailsHeight+=8;
         $pp_details.remove();
         pp_contentHeight=height+detailsHeight+$pp_pic_holder.find('.pp_bottom').height()+25;
         pp_contentWidth=720;
         pp_containerHeight=pp_contentHeight+$ppt.height()+$pp_pic_holder.find('.pp_top').height()+$pp_pic_holder.find('.pp_bottom').height();
         pp_containerWidth=720;
      ...
      function _insert_gallery(){
         if(isSet&&settings.overlay_gallery&&_getFileType(pp_images[set_position])=="image"){
            ...
            if(totalPage==0){
               navWidth=0;$pp_pic_holder.find('.pp_gallery .pp_arrow_next,.pp_gallery .pp_arrow_previous').hide();
            }
            else{
            ...
            $('.pp_gallery').css ({
               'margin-top':'10px'
               //'margin-top': $('.pp_gallery').css('margin-bottom')/2
            });
      ...
      function _buildOverlay(caller){
         ...
         if(isSet&&settings.overlay_gallery){
            ...
            $pp_pic_holder.find('.pp_gallery ul li').each(function(i){
               $(this).css({
                  'position':'absolute','left':i*itemWidth
               });
